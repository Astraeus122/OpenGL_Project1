...
GLuint TerrainMap::getVAO() const {
    return vao;  // Assuming the VAO is stored in the terrain class
}

GLuint TerrainMap::getIndexCount() const {
    return indices.size();  // Assuming 'indices' is a vector of indices for terrain rendering
}
